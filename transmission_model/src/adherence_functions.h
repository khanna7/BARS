...
void initialize_prep_adherence(std::shared_ptr<Person> person, double first_art_at_tick);
void schedule_prep_adherence(std::shared_ptr<Person> person, double first_art_at_tick);
