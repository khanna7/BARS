...
# specified probability
	...
	asm.25_30 <- 0.0028 / (365 * 5)
	asm.30_35 <- 0.003451 / (365 * 5)
	asm.35_40 <- 0.003477 / (365 * 5)
	asm.40_45 <- 0.004394 / (365 * 5)
	asm.45_50 <- 0.006315 / (365 * 5)
	asm.50_55 <- 0.010228 / (365 * 5)
	asm.55_60 <- 0.01605 / (365 * 5)
	asm.60_65 <- 0.022538 / (365 * 5)
	asm.65_70 <- 0.030628 / (365 * 5)
