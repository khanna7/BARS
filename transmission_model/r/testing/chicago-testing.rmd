...
```{r, echo=FALSE}
## data
net <- readRDS("../../Release/output/main_network_25000.RDS") #main network at the end
cas_net <- readRDS("../../Release/output/casual_network_25000.RDS")#casual network at the end

biom_data <- read.csv("../../Release/output/biomarker_log_40.csv")
counts_data <- read.csv("../../Release/output/counts_40.csv")
inf_event_data <- read.csv("../../Release/output/infection_events_40.csv")
death_data <- read.csv("../../Release/output/death_events_40.csv")
partnership_event_data <- read.csv("../../Release/output/partnership_events_40.csv")
...
require(data.table)
pt_data <- fread("../../Release/output/partnership_events_40.csv")
