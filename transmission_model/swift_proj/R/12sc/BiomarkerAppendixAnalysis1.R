...
#You should have the 90 days disruption and the 720 days disruption period
BMAResults<-lapply(1:60,BMA)
mat1<-matrix(NA,nrow=60,ncol=3568) #3568 was what I got when I observed the complete number of data points, as you go further off you will drift further and further away
for(i in 1:60){
...
#Plot out as far as time=1500
x<-1500
BMR1<-mat1[1:30,] #90 day disruption
BMR2<-mat1[31:60,] #720 day disruption
...
b<-.00092*2.89^(3.460476-4.2) #Derived from vecb
