...
df <- 
  expand.grid(
    ...
    post.release.interference.period.mean = 180
    #stop.at = 3650,
...
#write(res,file = "net_desr.txt")
#write(res,file = "net_desr_low.txt")
#write(res,file = "net_desr_high.txt")
#write(res,file = "care_desr.txt")
#write(res,file = "care_desr_low.txt")
write(res,file = "care_desr_high.txt")
#write(res,file = "both_desr.txt")
