...
full_res <- read.csv("../data/v54-serodiscordant-final_results.csv", header=FALSE) #final results
loc <- "../../v54-serodiscordant"
...
#saveRDS(object = dt, file = "out/v54-serodiscordant.RDS")
dt <- readRDS("out/v54-serodiscordant.RDS")
...
mean.newinf.across.years %>% 
  filter(ycat == 10)  #odd rows = main, even rows = all
