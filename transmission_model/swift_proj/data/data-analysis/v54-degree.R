...
full_res <- read.csv("../data/v54-degree-final_results.csv", header=FALSE) #final results
loc <- "../../v54-degree"

in1 <- read.table(paste0(loc,"/instance_1/output/parameters.txt"))
upf <- read.table(paste0(loc, "/degree.txt"), sep=",")
...
#saveRDS(object = dt, file = "out/v54-degree.RDS")
dt <- readRDS("out/v54-degree.RDS")
