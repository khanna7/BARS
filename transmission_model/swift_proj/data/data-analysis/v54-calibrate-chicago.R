...
full_res <- read.csv("../data/v54-calibrate-chicago-final_results.csv", header=FALSE) #final results
loc <- "../../v54-calibrate-chicago"

in1 <- read.table(paste0(loc,"/instance_1/output/parameters.txt"))
#param_list <- read.csv("../../../data/sens_param_six_swp_fine_grained_min_ch_inf_low.csv")
upf <- read.table(paste0(loc, "/calibrate-chicago.txt"), sep=",")
...
## Check outcomes on instances of interest      
   ...
   write.csv(calib_dt, file="out/v54-calibrate-chicago_dt.csv")
...
library(ergm)
   ...
   main_net <- readRDS("../../v54-calibrate-chicago/instance_245/output/main_network_36500.RDS")
   casual_net <- readRDS("../../v54-calibrate-chicago/instance_245/output/casual_network_36500.RDS")
   parameters <- read.table("../../v54-calibrate-chicago/instance_245/output/parameters.txt")
...
# Annualized incidences in instance_248 ----
  ...
  dt <- summarize_directory("/project/khanna7/Projects/midway2/BARS/transmission_model/swift_proj/experiments/v54-calibrate-chicago-instance_248", ranges=ranges)
  saveRDS(object = dt, file = "out/v54-instance_248.RDS")
