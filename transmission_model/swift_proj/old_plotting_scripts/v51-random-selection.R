...
full_res <- read.csv("../data/v51-random-selection-final_results.csv", header=FALSE) #final results
loc <- "../../v51-random-selection"
...
#saveRDS(object = dt, file = "out/v51-random-selection-final_results.RDS")
dt <- readRDS("out/v51-random-selection-final_results.RDS")
...
ggsave("out/v51-random-selection-inc-data.png")
