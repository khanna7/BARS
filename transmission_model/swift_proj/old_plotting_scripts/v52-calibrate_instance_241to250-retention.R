...
full_res <- read.csv("../data/v52-calibrate_instance_241to250-retention-final_results.csv", header=FALSE) #final results
loc <- "../../v52-calibrate_instance_241to250-retention"
...
#saveRDS(object = dt, file = "out/v52-calibrate_instance_241to250-retention.RDS")
dt <- readRDS("out/v52-calibrate_instance_241to250-retention.RDS")
...
ggsave("out/v52-calibrate_instance_241to250-retention.png")
