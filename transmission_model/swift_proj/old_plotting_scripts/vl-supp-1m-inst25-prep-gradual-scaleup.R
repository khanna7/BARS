...
full_res <- read.csv("../data/vl-supp-1m-inst25-prep-gradual-scaleup-final_results.csv", header=FALSE) #final results
loc <- "../../vl-supp-1m-inst25-prep-gradual-scaleup"
...
saveRDS(object = dt, file = "out/vl-supp-1m-inst25-prep-gradual-scaleup.RDS")
...
View(tenthyr.outcomes) #scale usage

## PrEP summary ----
View(responses) #scale usage
...
ggsave("out/vl-supp-1m-inst25-prep-gradual-scaleup-inc-data.png")
