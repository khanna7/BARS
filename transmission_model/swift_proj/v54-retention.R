...
full_res <- read.csv("../data/v54-retention-final_results.csv", header=FALSE) #final results
loc <- "../../v54-retention"
...
#saveRDS(object = dt, file = "out/v54-retention.RDS")
dt <- readRDS("out/v54-retention.RDS")
